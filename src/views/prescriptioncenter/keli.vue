...
<script>
  import {dictionaryByName, getInfo, getListd, receiveBlenderSave, receiveDecoctingSave, selectListByDrugCategory,selectByOrderId} from "@/api/order/order";
  ...
  export default {
    ...
    methods: {
      ...
      onLoad(page, params = {}) {
        ...
        this.loading = true;
        getListd(page.currentPage, page.pageSize, Object.assign(values, this.query)).then(res => {
