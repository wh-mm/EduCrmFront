    ...
    <avue-crud :option="option"
        ...
        <template slot-scope=""  slot="menuLeft">
          ...
          <el-button type="button"
                     size="small"
                     v-if="permission.manager_approval"
                     @click="updateManagerNew()">审批
          </el-button>
...
<script>
  import {getList, add, getDetail, update, remove, updateManager, viewCommodity, updaterejectText} from "@/api/purchase/purchaseorder";
  ...
  export default {
    ...
    computed: {
      ...
      permissionList() {
        return {
          addBtn: this.vaildData(this.permission.manager_add, false),
          viewBtn: this.vaildData(this.permission.manager_view, false),
          delBtn: this.vaildData(this.permission.manager_delete, false),
          editBtn: this.vaildData(this.permission.manager_edit, false)
        };
      },
      ids() {
        let ids = [];
    ...
    methods: {
      ...
      updateManagerNew() {
        ...
        if (this.selectionList[0].status != 5  && this.selectionList[0].status !=106){
      ...
      updaterejectTextNew() {
        if(this.status1 === 105 && this.obj0Reason.rejectText === '' ){
