...
export default {
  ...
  computed: {
    ...
    permissionList() {
      return {
        addBtn: this.vaildData(this.permission.orderpartiescategory_add, false),
        viewBtn: this.vaildData(this.permission.orderpartiescategory_view, false),
        delBtn: this.vaildData(this.permission.orderpartiescategory_delete, false),
        editBtn: this.vaildData(this.permission.orderpartiescategory_edit, false)
      };
    },
    ids() {
      let ids = [];
